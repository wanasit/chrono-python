...
def test_slash_swap_month_day():
    ...
    assert result.moment.get(CivilTimeComponent.YEAR) == 2015
...
def test_slash_two_digit_year():
    ...
    assert result.moment.get(CivilTimeComponent.YEAR) == 2016
    assert result.moment.get(CivilTimeComponent.MONTH) == 12
    assert result.moment.get(CivilTimeComponent.DAY) == 30


def test_slash_pattern_yyyy_mm_dd_hyphen():
    results = chrono.parse('2015-05-25')
    assert len(results) == 1
    assert results[0].moment.get(CivilTimeComponent.YEAR) == 2015
    assert results[0].moment.get(CivilTimeComponent.MONTH) == 5
    assert results[0].moment.get(CivilTimeComponent.DAY) == 25
...
def test_slash_extra_chunk():
    ...
    assert result.moment.get(CivilTimeComponent.DAY) == 14
