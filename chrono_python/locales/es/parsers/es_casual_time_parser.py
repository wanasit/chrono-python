...
PATTERN = re.compile(
    r"(?:esta\s*)?(mañana|tarde|medianoche|mediodia|mediodía|noche)(?=\W|$)",
    re.IGNORECASE,
)


class ESCasualTimeParser(AbstractParserWithWordBoundary):
    ...
    def inner_extract(
        ...
        elif lower_word in ("mediodia", "mediodía"):
            component.imply(CivilTimeComponent.MERIDIEM, Meridiem.AM)
