...
PATTERN = re.compile(
    r"(agora|hoje|amanha|amanhã|ontem)(?=\W|$)",
    re.IGNORECASE,
)


class PTCasualDateParser(AbstractParserWithWordBoundary):
